module HashHelperMethods
  ...
  def answered_question_attributes_sym(survey_question, question_type, options)
    {
  ...
  def answers_survey_question_attributes_hash(survey_question, question_type, options)
    {
      'id' => survey_question.id,
      'name' => survey_question.name,
  ...
  def asnwers_survey_returned_params(params = {})
    {
      'id' => params[:answers_survey].id,
      'user_id' => params[:answers_survey].user_id,
      'status' => params[:answers_survey].status,
