...
RSpec.describe 'RolesController', type: :request do
  describe '#list' do
    ...
    let!(:all_roles) do
      [{ 'id' => role_moderator.id, 'role_type' => role_moderator.role_type }, { 'id' => role_admin.id, 'role_type' => role_admin.role_type },
    ...
    describe 'when admin, list all roles' do
      ...
      it 'all roles' do
        expect(response_body).to match(all_roles)
      end
    end
    ...
    describe 'when user is not admin, list all not admin roles' do
      ...
      it 'Not admin roles' do
        expect(response_body).to match(not_admin_roles)
      end
